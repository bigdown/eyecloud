...
<div class="wrapper" id="rrapp" v-cloak>
  <header class="main-header">
    <a href="javascript:void(0);" class="logo">
      ...
      <span class="logo-mini"><b>eye</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>eyecloud</b></span>
    </a>
  ...
  <footer class="main-footer">
    ...
    Copyright &copy; 2019 <a href="https://www.renren.io" target="_blank">eyecloud.com</a> All Rights Reserved
  </footer>
...
<script src="${request.contextPath}/static/libs/jquery.min.js"></script>
<script src="${request.contextPath}/static/libs/vue.min.js"></script>
<script src="${request.contextPath}/static/libs/router.js"></script>
<script src="${request.contextPath}/static/libs/bootstrap.min.js"></script>
<script src="${request.contextPath}/static/libs/app.js"></script>
