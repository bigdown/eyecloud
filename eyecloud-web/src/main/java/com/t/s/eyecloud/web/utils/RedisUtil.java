package com.t.s.eyecloud.web.utils;

import com.t.s.eyecloud.web.config.JedisConfig;
...
public class RedisUtil {
    ...
    private RedisUtil() {
        if (pool == null) {
            String ip = JedisConfig.SPRING_REDIS_HOST;
            int port = Integer.valueOf(JedisConfig.SPRING_REDIS_PORT);
            String password = JedisConfig.SPRING_REDIS_PASSWORD;
            JedisPoolConfig jedisPoolConfig = new JedisPoolConfig();
            jedisPoolConfig.setMaxTotal(Integer.valueOf(JedisConfig.SPRING_REDIS_JEDIS_POOL_MAXACTIVE));
            jedisPoolConfig.setMaxIdle(Integer.valueOf(JedisConfig.SPRING_REDIS_JEDIS_POOL_MAXIDLE));
    ...
    public Object evalsha(String sha, List<String> keys, List<String> args){
        Jedis jedis = getJedis();
        return jedis.evalsha(jedis.scriptLoad(sha), keys, args);
    }

    private Jedis getJedis() {
        try (Jedis jedis = pool.getResource()) { return jedis; }
    }
