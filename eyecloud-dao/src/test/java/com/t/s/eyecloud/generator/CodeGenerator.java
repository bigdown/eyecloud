package com.t.s.eyecloud.generator;
    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig("/templates/entity.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/eyecloud-domain/src/main/java/com/t/s/eyecloud/model/" + tableInfo.getEntityName()
                        + StringPool.DOT_JAVA;
            }
        });
        // 自定义mapper层路径
        focList.add(new FileOutConfig("/templates/mapper.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + "/eyecloud-dao/src/main/java/com/t/s/eyecloud/mapper/" + tableInfo.getEntityName() + "Mapper"
                        + StringPool.DOT_JAVA;
            }
        });
        // 自定义mapper层路径
        ...
        focList.add(new FileOutConfig("/templates/service.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + "/eyecloud-dao/src/main/java/com/t/s/eyecloud/dao/" + "I"
        ...
        focList.add(new FileOutConfig("/templates/serviceImpl.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + "/eyecloud-dao/src/main/java/com/t/s/eyecloud/dao/impl/"
