...
//        face();
    ...
    public static void getVideoFromFile() {
        ...
        capture.open("E:\\facevideo\\1.avi");//1 读取视频文件的路径
    ...
    public static Mat getFace(Mat image) {
        ...
        if(rects != null && rects.length >= 1) {
            ...
            for (int i = 0; i < rects.length; i++) {
                ...
                Imgcodecs.imwrite("E:\\facevideo\\" + "face"+ i +".png", image);
                //Mat dst=image.clone();
    ...
    public static void face() {
        ...
        //        CascadeClassifier facebook=new CascadeClassifier("D:\\Sofeware\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
        // 2 读取测试图片
        String imgPath = "E:\\facevideo\\he.png";
        ...
        for (Rect rect : face.toArray()) {
            ...
            imageCut(imgPath, "E:\\facevideo\\"+i+".jpg", rect.x, rect.y, rect.width, rect.height);// 进行图片裁剪
            i++;
        }
        // 6 展示图片
    ...
    public static void writeVideo() {
        ...
        VideoWriter writer=new VideoWriter("E:\\facevideo\\a.mp4",VideoWriter.fourcc('D', 'I', 'V', 'X'), 15.0,size, true);
        while(capture.isOpened()) {
